...
class TikTokApp:
    ...
    def define_coleccion(self, url, getDescripciones=False):
        print("Vamos a ver las colecciones de tu perfil")
        if self.driver.current_url != PROFILE_TIKTOK:
                print(f"Nos dirigimos a la URL: {PROFILE_TIKTOK}")
                self.driver.get(PROFILE_TIKTOK)
        
        self.driver.find_element(By.XPATH, "//*[contains(text(), 'Favoritos')]").click()
        self.driver.find_element(By.XPATH, "//*[contains(text(), 'Colecciones')]").click()
        ...
        idColeccion = int(input("\nIntroduce el ID de la colección: "))
